                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form class="form-horizontal"
                                              action="{{ route("users.update",$data->id) }}" method="post"
                                            ...
                                            <div class="form-group row">
                                                <label class="col-md-3 col-form-label"
                                                       for="password-input">old Password</label>
                                                <div class="col-md-9">
                                                    ...
                                                    @if($errors->get('old_password'))
                                                        <br>
                                                        <div class="alert alert-danger"
                                                             role="alert">{{ $errors->first('old_password') }}</div>
                                                    @endif
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                <label class="col-md-3 col-form-label"
                                                       for="password-input">New Password</label>
                                                <div class="col-md-9">
