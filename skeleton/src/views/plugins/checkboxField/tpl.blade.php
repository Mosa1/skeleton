...
<div class="form-group row">
    <label class="col-md-3 col-form-label" for="checkbox-input">{{ $properties->title }} print_start $value print_end</label>
    <div class="col-md-1">
        <input class="form-control" value="1" type="checkbox" name="{{ $fieldName }}">
