...
<div class="form-group row">
    ...
    <div class="col-md-9">
        <div class="input-group"><div class="input-group-prepend"><span class="input-group-text"><i class="fa fa-calendar"></i></span></div><input autocomplete="off" type="text" class="form-control" id="{{$plugin_id}}" value="print_start $value print_end" name="{{ $fieldName }}"></div>
